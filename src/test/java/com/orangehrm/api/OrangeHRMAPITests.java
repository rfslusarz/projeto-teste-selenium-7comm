...
public class OrangeHRMAPITests {
     ...
     * pois o OrangeHRM usa autenticação via Sessão/Cookies e OAuth (não disponível no demo).
     */
    @Test
    ...
    public void testOrangeHRMDisponibilidade() {
        ...
        Assertions.assertEquals(200, response.getStatusCode(), "A página de login do OrangeHRM deveria estar acessível");
    }

    /**
     * Tenta simular um login inválido via formulário web.
     * Mapeamento de Status:
     * - API 401 (Unauthorized) -> Web: Redirecionamento (302) de volta para /login ou 200 com erro.
     */
    @Test
